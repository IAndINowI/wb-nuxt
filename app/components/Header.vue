...
<script setup>
	let links	= ref([
{id:0,
	route:{path:"/products", query: {field:"gender", name: 'Womens'}}, text:"Womens"},
{id:1,
	route:{path:"/products", query: {field:"gender", name: 'Mens'}}, text:"Mens"},
{id:2,
	route:{path:"/products", query: {field:"category", name: 'Clothing'}}, text:"Clothing"},
{id:3,
	route:{path:"/products", query: {field:"category", name: 'Accessories'}}, text:"Accessories"},
{id:4,
	route:{path:"/products", query: {field:"category", name: 'Shoes'}}, text:"Shoes"},
{id:5,
